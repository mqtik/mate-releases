# File Transfer (/docs/features/file-transfer)
...
<Steps>
  ...
  Choose one or more files from your device. You can select multiple files at once.

  ### Pick a destination [#pick-a-destination]

  Select the paired device you want to send to from the device list.

  ### Send [#send]

  The files transfer directly over your local network. Large files transfer quickly since there is no cloud relay — data goes straight from device to device.
</Steps>
...
Any file type is supported. There are no restrictions on what you can send — documents, images, videos, code archives, binaries, or anything else.

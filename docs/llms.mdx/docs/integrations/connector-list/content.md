# Connector List (/docs/integrations/connector-list)
...
Connectors for databases and data storage.
...
| Supabase      | Manage Supabase projects, tables, and auth |
| Qdrant        | Vector search and similarity queries       |
| MySQL         | Query and manage MySQL databases           |
| Neon          | Serverless Postgres database management    |
| Upstash       | Serverless Redis and Kafka                 |
| Turso         | Edge SQLite database management            |
...
| CouchDB       | Manage CouchDB databases and documents     |
...
| Tavily       | AI-optimized web search and content extraction   |
| Firecrawl    | Web scraping and content crawling                |
| Apify        | Web scraping and browser automation at scale     |
| Google Maps  | Location data, directions, and place information |

## Productivity [#productivity]

Project management, notes, and team collaboration.

| Connector                     | Description                                         |
| ----------------------------- | --------------------------------------------------- |
| Slack                         | Send messages and manage Slack channels             |
| Notion                        | Search, read, and manage Notion pages and databases |
| Linear                        | Create and manage issues, projects, and cycles      |
| Google Workspace              | Gmail, Drive, Docs, and Sheets                      |
| Todoist                       | Task management and to-do lists                     |
| Atlassian (Jira + Confluence) | Issue tracking and team documentation               |
| Asana                         | Project and task management                         |
| ClickUp                       | Project management and team collaboration           |
| Trello                        | Kanban boards and task tracking                     |
| Obsidian                      | Manage Obsidian vault notes and searches            |
| Google Calendar               | Manage calendar events and schedules                |
| Resend                        | Send transactional emails                           |
| Mailgun                       | Email delivery and management                       |
| 1Password                     | Secure credential and secret management             |
...
| Connector           | Description                                          |
| ------------------- | ---------------------------------------------------- |
| X (Twitter)         | Post tweets, read timelines, and manage your account |
| Discord             | Send messages and manage Discord servers             |
| Reddit              | Browse subreddits, read posts, and manage comments   |
| Telegram            | Send messages and manage Telegram chats              |
| WhatsApp            | Send and receive WhatsApp messages                   |
| YouTube             | Search videos, manage channels, and read comments    |
| Instagram           | Manage posts and interactions                        |
| Facebook (Meta Ads) | Manage Facebook ad campaigns                         |

## Commerce [#commerce]

E-commerce, CRM, and payment platforms.

| Connector    | Description                                      |
| ------------ | ------------------------------------------------ |
| Stripe       | Manage payments, subscriptions, and customers    |
| Shopify      | Manage products, orders, and store configuration |
| MercadoLibre | Manage listings and orders on MercadoLibre       |
| HubSpot      | CRM, marketing, and sales management             |
| Salesforce   | CRM and sales pipeline management                |

## AI & Media [#ai--media]

Image generation, media processing, and design tools.

| Connector                         | Description                                  |
| --------------------------------- | -------------------------------------------- |
| Gemini Image (Nano Banana)        | Generate images using Google Gemini          |
| OpenAI Image (DALL-E / GPT Image) | Generate and edit images with DALL-E         |
| Stability AI (Stable Diffusion)   | Generate images with Stable Diffusion models |
| Replicate                         | Run hosted ML models on demand               |
| fal.ai                            | Fast inference for generative AI models      |
| ElevenLabs                        | Text-to-speech and voice synthesis           |
| MiniMax                           | AI model inference and generation            |
| Image Reader                      | Extract text and data from images            |
| MCP Images                        | Image processing and manipulation via MCP    |
| FFmpeg Media                      | Audio and video processing and conversion    |
| Figma                             | Read and manage Figma design files           |
| Magic UI (21st.dev)               | AI-powered UI component generation           |
